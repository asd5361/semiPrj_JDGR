...
<div class="blog_left">
    ...
    <div class="blog_category">
        ...
        <ul>
        	<li class="category"><a href="/jdgr/post/detail?url=${blogUrlVo.blogUrl}"><strong>전체보기</strong><span>(12)</span></a></li>
        	<% if(groupVoList != null){ %>
        		<% for(GroupVo groupVo : groupVoList){ %>
        			<li class="category"><a href="/jdgr/post/detail?url=${blogUrlVo.blogUrl}&&categoryNo=<%= groupVo.getNo() %>"><strong><%= groupVo.getName() %></strong><span>(3)</span></a></li>
        		<% } %>
        	<% } %>
            <li class="line"></li>
        </ul>
