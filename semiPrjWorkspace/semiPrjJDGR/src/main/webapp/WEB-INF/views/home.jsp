...
<script>
    ...
    function goPost(event) {
            ...
            input.type = "hidden";
            input.name = "pNo";//파라미터 값으로 받기 위해 name값을 넣는다.
            input.value = postNo;
    ...
    for(let i = 0 ; i < divArr.length; ++i){
    	divArray[i].addEventListener('click' , selectCategory);
    }
...
//         	const input = document.createElement("input");
//             input.type = "hidden";
//             input.name = "categoryNo";//파라미터 값으로 받기 위해 name값을 넣는다.
